                    ...
                    {menuOpen && (
                      ...
                      >
                        ...
                        <div className="p-2">
                          ...
                          <Link
                            to="/profile"
                            className="flex items-center gap-2 px-3 py-2 text-sm rounded-md text-gray-700 hover:bg-gray-100 no-underline group"
                            onClick={() => setMenuOpen(false)}
                          >
                            <svg
                              className="w-4 h-4"
                            ...
                            {(() => {
                              ...
                              const badgeColor = getCompletionBadgeColor(
