      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-[var(--primary)] to-blue-900 rounded-2xl p-8 text-white">
        <div className="relative z-10">
          ...
          <p className="text-blue-100 text-lg">
            Help us improve the portal, processes, and services for all members
          </p>
        </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-green-700">
                  Your suggestion has been submitted successfully. We appreciate
                  your contribution to improving our services.
                </p>
              </div>
              <button
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">
                We review all suggestions promptly and implement valuable ideas
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-green-700">
                About being able to see how suggestions are being implemented{" "}
              </p>
            </div>
          </div>
        </motion.div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-purple-700">
                Your feedback drives our platform evolution
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <div className="flex items-center gap-3 mb-6 pb-6 border-b">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Share detailed feedback to help us serve you better
            </p>
          </div>
        </div>
            ...
            {files.length > 0 && (
              <div className="mt-4 space-y-2">
                {files.map((file, idx) => (
                  <div
                    key={idx}
                    className="flex items-center gap-3 bg-gray-50 rounded-lg p-3 border"
                  >
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="font-bold text-gray-900 mb-2">
              What kind of suggestions can I share?
            </h3>
            <ul className="space-y-1 text-sm text-gray-700">
              <li className="flex items-start gap-2">
                <span className="text-[var(--accent)] mt-1">•</span>
                <span>
                  Portal feature improvements and new functionality ideas
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[var(--accent)] mt-1">•</span>
