    ...
    >
      ...
      <div className="px-4 sm:px-6 py-3 bg-blue-50 border-b border-blue-100">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm sm:text-base font-semibold text-[var(--primary)]">
              ...
              <div className="flex items-center justify-center">
                {currentAd.imageUrl ? (
                  ...
                  <div className="w-full h-80 rounded-lg shadow-lg overflow-hidden">
                    {currentAd.videoUrl.includes("youtube.com") ||
                    currentAd.videoUrl.includes("youtu.be") ? (
                      <iframe
                ...
                <div className="flex items-center gap-2 mb-3">
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-bold ${
                      currentAd.type === "announcement"
                        ? "bg-blue-500 text-white"
                        : currentAd.type === "achievement"
...
export default function Dashboard() {
  ...
  const [totals, setTotals] = useState<{
    ...
    members: number;
    courtCases: number;
  }>({ divisions: 0, members: 0, courtCases: 0 });
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 lg:gap-8">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4 sm:mb-6">
                ...
                advocacy, and community support across Central Railway. We stand
                united for the welfare, rights, and professional development of
              ...
              {[
                {
                  icon: "⚖️",
                  title: "Legal Support",
                  desc: "Expert legal assistance",
                },
                {
                  icon: "🏥",
                  title: "Welfare Programs",
                  desc: "Medical & financial aid",
                },
                {
                  icon: "📚",
                  title: "Resources",
                  desc: "Manuals & guidelines",
                },
                { icon: "🤝", title: "Networking", desc: "Connect nationwide" },
                {
                  icon: "🎓",
                  title: "Training",
                  desc: "Development workshops",
                },
                {
                  icon: "📢",
                  title: "Advocacy",
                  desc: "Strong representation",
                },
              ].map((benefit, index) => (
                <motion.div
                  key={index}
                ...
                >
                  ...
                  <h3 className="font-semibold text-sm text-[var(--primary)] mb-0.5">
                    {benefit.title}
                  </h3>
                ...
                <div className="border-l-3 border-blue-500 pl-3">
                  ...
                  <div className="space-y-1.5">
                    {events.slice(0, 3).map((e) => (
                      <div
                        key={e.id}
                        className="text-xs text-gray-600 hover:text-gray-900 cursor-pointer line-clamp-1"
                      >
                        • {e.title} - {e.location}
                      </div>
                    ))}
